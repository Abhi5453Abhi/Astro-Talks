  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Update userProfile with the returned user data (including ID)
              ...
              >
                ...
                {Array.from({ length: 31 }, (_, i) => i + 1).map((day, index) => {
                  ...
                  return (
                    <div
                      key={day}
                      className={`h-12 flex items-center justify-center text-base sm:text-xl snap-center cursor-pointer transition-all relative z-10 leading-none ${
                        isSelected
            ...
            <div className="flex-[2] min-w-0 relative">
              ...
              >
                ...
                {['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'].map((month, index) => {
                  ...
                  const isSelected = index + 1 === birthDate.month
                  return (
                    <div
                      key={month}
                      className={`h-12 flex items-center justify-center text-sm sm:text-lg snap-center cursor-pointer transition-all relative z-10 leading-none ${
                        isSelected
                          ? 'text-yellow-400 font-bold scale-110'
                          : 'text-gray-500 font-light'
                      }`}
            ...
            <div className="flex-1 min-w-0 relative">
              ...
              >
                ...
                {Array.from({ length: 100 }, (_, i) => new Date().getFullYear() - i).map((year, index) => {
                  ...
                  const isSelected = year === birthDate.year
                  return (
                    <div
                      key={year}
                      className={`h-12 flex items-center justify-center text-base sm:text-xl snap-center cursor-pointer transition-all relative z-10 leading-none ${
